...
% This example shows how to use the Universal Software Radio Peripheral(TM)
% (USRP) device using SDRu (Software Defined Radio USRP) System objects to
% implement a QPSK transmitter. The USRP device in this system will keep
% transmitting indexed "Hello world" messages at its specified center
% frequency and at bit rate of 2Mbps. You can demodulate the transmitted
% message using the <docid:usrpradio_ug#example-sdruQPSKReceiver QPSK
% Receiver with USRP® Hardware> example with an additional USRP device.
%
...
% with USRP hardware. There is another implementation of this example
...
% System object and the USRP hardware. 
...
%%
% The gain behavior of different USRP daughter boards varies
